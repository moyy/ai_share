...
- [2. 项目 / 框架](#2-项目--框架)
  ...
  - [2.04. Madrona：基于GPU加速的高吞吐模拟器的原型游戏引擎](#204-madrona基于gpu加速的高吞吐模拟器的原型游戏引擎)
  - [2.05. 自动训练 的 AI Agent](#205-自动训练-的-ai-agent)
  - [2.06. VirtualWife: 虚拟主播项目，目前支持在B站进行直播](#206-virtualwife-虚拟主播项目目前支持在b站进行直播)
  - [2.07. FaceChain：打造个人数字形象的深度学习模型工具](#207-facechain打造个人数字形象的深度学习模型工具)
  - [2.08. AgentSims: 用于 LLM 评估的开源沙盒](#208-agentsims-用于-llm-评估的开源沙盒)
  - [2.09. 用AI生成高质量电子书](#209-用ai生成高质量电子书)
  - [2.10. AI Town：适合自己构建和定制的AI小镇JS入门套件——一个虚拟小镇](#210-ai-town适合自己构建和定制的ai小镇js入门套件一个虚拟小镇)
- [3. 模型](#3-模型)
...
## 2.04. [Madrona：基于GPU加速的高吞吐模拟器的原型游戏引擎](https://github.com/shacklettbp/madrona)

能在单个GPU上运行成千上万个虚拟环境实例，每秒生成数百万个模拟步骤，这种高效率对于高性能AI智能体的训练(如通过强化学习)或需要将高性能环境模拟器紧密集成到更广泛应用中的任务非常有用。

## 2.05. [自动训练 的 AI Agent](https://github.com/mshumer/gpt-llm-trainer​​)

只需写一句你想训练做什么任务的大模型，一系列AI Agents将为你生成数据集并训练模型。

来自HyperWriteAI创始人Matt Shumer，

## 2.06. [VirtualWife: 虚拟主播项目，目前支持在B站进行直播](https://github.com/yakami129/VirtualWife)

用户可以自由更换VRM人物模型，大家可以将他作为一个虚拟主播入门demo，在上面扩展自己喜欢功能。

## 2.07. [FaceChain：打造个人数字形象的深度学习模型工具](https://github.com/modelscope/facechain)

仅需要提供最低三张照片即可获得独属于自己的个人形象数字替身 

## 2.08. [AgentSims: 用于 LLM 评估的开源沙盒](https://github.com/py499372727/AgentSims)

## 2.09. [用AI生成高质量电子书](https://github.com/easychen/book-by-ai)

## 2.10. [AI Town：适合自己构建和定制的AI小镇JS入门套件——一个虚拟小镇](github.com/a16z-infra/AI-town)
