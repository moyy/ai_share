...
- [1. 工具](#1-工具)
  ...
  - [1.22. ​​产品搜索: similarweb.com \&\& toolify.ai](#122-产品搜索-similarwebcom--toolifyai)
  - [1.23. 微博 @Barret李靖: 怎么把散落在各个平台的「宝藏」信息给聚合起来，放到一块儿关注](#123-微博-barret李靖-怎么把散落在各个平台的宝藏信息给聚合起来放到一块儿关注)
  - [1.24. Nougat: Meta OCR, 将学术 PDF 文档转换为 Multi Markdown](#124-nougat-meta-ocr-将学术-pdf-文档转换为-multi-markdown)
  - [1.25. 输入 YouTube 链接，就可以开始与 Al 聊天、获取摘要、做笔记](#125-输入-youtube-链接就可以开始与-al-聊天获取摘要做笔记)
- [2. 项目 / 框架](#2-项目--框架)
  ...
  - [2.05.基于Llama2的AI小镇](#205基于llama2的ai小镇)
  - [2.06. AI Town：适合自己构建和定制的AI小镇JS入门套件——一个虚拟小镇](#206-ai-town适合自己构建和定制的ai小镇js入门套件一个虚拟小镇)
  - [2.07. Madrona：基于GPU加速的高吞吐模拟器的原型游戏引擎](#207-madrona基于gpu加速的高吞吐模拟器的原型游戏引擎)
  - [2.08. 自动训练 的 AI Agent](#208-自动训练-的-ai-agent)
  - [2.09. VirtualWife: 虚拟主播项目，目前支持在B站进行直播](#209-virtualwife-虚拟主播项目目前支持在b站进行直播)
  - [2.10. FaceChain：打造个人数字形象的深度学习模型工具](#210-facechain打造个人数字形象的深度学习模型工具)
  - [2.11. AgentSims: 用于 LLM 评估的开源沙盒](#211-agentsims-用于-llm-评估的开源沙盒)
  - [2.12. 用AI生成高质量电子书](#212-用ai生成高质量电子书)
  - [2.13. Flowise：用简单的拖放 UI 构建定制的 LLM 应用程序](#213-flowise用简单的拖放-ui-构建定制的-llm-应用程序)
  - [2.14. GPT-vup Live2D 数字人直播](#214-gpt-vup-live2d-数字人直播)
  - [2.15. SillyTavern 本地部署的虚拟角色聊天软件](#215-sillytavern-本地部署的虚拟角色聊天软件)
  - [2.16. OpenCopilot：为各种SaaS产品提供自己的AI助手](#216-opencopilot为各种saas产品提供自己的ai助手)
  - [2.17. 麻将AI竞技场](#217-麻将ai竞技场)
  - [2.18. `Council`: 旨在通过团队协作的方式，快速开发和部署定制强大生成式AI应用的开源平台](#218-council-旨在通过团队协作的方式快速开发和部署定制强大生成式ai应用的开源平台)
  - [2.19. `AgentLLM`：利用开源大语言模型 (LLM) 开发、仅在浏览器上运行的自主智能体的概念证明](#219-agentllm利用开源大语言模型-llm-开发仅在浏览器上运行的自主智能体的概念证明)
  - [2.20. `LLMStack` 无代码平台，用于构建生成式 AI 应用、聊天机器人、智能体并将它们连接到数据和业务流程](#220-llmstack-无代码平台用于构建生成式-ai-应用聊天机器人智能体并将它们连接到数据和业务流程)
  - [2.21. `AutoAgents` 多智能体自动生成框架，基于LLM的自动智能体生成的实验性开源应用，由LLM驱动，自主生成多智能体以实现设定的目标](#221-autoagents-多智能体自动生成框架基于llm的自动智能体生成的实验性开源应用由llm驱动自主生成多智能体以实现设定的目标)
  - [2.22. `Metaphor`：一种基于大语言模型的搜索引擎](#222-metaphor一种基于大语言模型的搜索引擎)
  - [2.23. `MindOS`: 提供 AI 对话，能力包括: `API`, `Workflow`, `Knowledge`, `Memory`](#223-mindos-提供-ai-对话能力包括-api-workflow-knowledge-memory)
- [3. 模型](#3-模型)
  ...
  - [3.10. AutoTrain: 微调HF LLM的UI工具](#310-autotrain-微调hf-llm的ui工具)
  - [3.11. CLIP 知识蒸馏：执行 OpenCLIP 模型的知识蒸馏，用零标记数据创建自定义图像分类模型](#311-clip-知识蒸馏执行-openclip-模型的知识蒸馏用零标记数据创建自定义图像分类模型)
  - [3.12. Giraffe：世界上第一个商业可用的32K长上下文开源LLM（基于Llama-2）](#312-giraffe世界上第一个商业可用的32k长上下文开源llm基于llama-2)
  - [3.13. Meta 发布 `Code Llama`](#313-meta-发布-code-llama)
- [4. 技巧 / 教程](#4-技巧--教程)
  ...
  - [4.11. 基于大语言模型的 AI Agents](#411-基于大语言模型的-ai-agents)
  - [4.12. OpenAI GPT-3.5 微调实战](#412-openai-gpt-35-微调实战)
  ...
  - [4.15. 孩子 国内 读IT，推荐 哪些课程](#415-孩子-国内-读it推荐-哪些课程)
- [4.16. GPT4 Promt（提示） 范例：帮助你 在不熟悉的领域 做出 工程决策：](#416-gpt4-promt提示-范例帮助你-在不熟悉的领域-做出-工程决策)
- [5. 资讯 / 观点](#5-资讯--观点)
  ...
  - [5.14. 资讯：ElevenLabs 多语言语音生成模型 Eleven Multilingual v2](#514-资讯elevenlabs-多语言语音生成模型-eleven-multilingual-v2)
...
## 1.22. ​​产品搜索: similarweb.com && toolify.ai
...
## 1.23. [微博 @Barret李靖: 怎么把散落在各个平台的「宝藏」信息给聚合起来，放到一块儿关注](https://weibo.com/1812166904/NgelUyiCC)
...
## 1.24. [Nougat: Meta OCR, 将学术 PDF 文档转换为 Multi Markdown](https://maeiee-garden.vercel.app/000.wiki/Neural%20Optical%20Understanding%20for%20Academic%20Documents/)

+ 尤其擅长复杂数学公式。
+ 扫描版的 PDF 也能转换，基于 Transformer 模型训练而成
+ 一键安装，一键运行，开箱即用！

## 1.25. [输入 YouTube 链接，就可以开始与 Al 聊天、获取摘要、做笔记](https://www.youlearn.ai)
...
## 2.05.[基于Llama2的AI小镇](https://github.com/rlancemartin/generative_agents)

## 2.06. [AI Town：适合自己构建和定制的AI小镇JS入门套件——一个虚拟小镇](github.com/a16z-infra/AI-town)

适合自己构建和定制的AI小镇JS入门套件——一个虚拟小镇，AI角色在其中资助生活、聊天和社交

## 2.07. [Madrona：基于GPU加速的高吞吐模拟器的原型游戏引擎](https://github.com/shacklettbp/madrona)

能在单个GPU上运行成千上万个虚拟环境实例，每秒生成数百万个模拟步骤，这种高效率对于高性能AI智能体的训练(如通过强化学习)或需要将高性能环境模拟器紧密集成到更广泛应用中的任务非常有用。

## 2.08. [自动训练 的 AI Agent](https://github.com/mshumer/gpt-llm-trainer​​)

只需写一句你想训练做什么任务的大模型，一系列AI Agents将为你生成数据集并训练模型。

来自HyperWriteAI创始人Matt Shumer，

## 2.09. [VirtualWife: 虚拟主播项目，目前支持在B站进行直播](https://github.com/yakami129/VirtualWife)

用户可以自由更换VRM人物模型，大家可以将他作为一个虚拟主播入门demo，在上面扩展自己喜欢功能。

## 2.10. [FaceChain：打造个人数字形象的深度学习模型工具](https://github.com/modelscope/facechain)

仅需要提供最低三张照片即可获得独属于自己的个人形象数字替身 

## 2.11. [AgentSims: 用于 LLM 评估的开源沙盒](https://github.com/py499372727/AgentSims)

## 2.12. [用AI生成高质量电子书](https://github.com/easychen/book-by-ai)

## 2.13. [Flowise：用简单的拖放 UI 构建定制的 LLM 应用程序](https://github.com/FlowiseAI/Flowise)
...
## 2.14. [GPT-vup Live2D 数字人直播](https://github.com/jiran214/GPT-vup)

支持BiliBili和抖音直播，基于生产者-消费者模型设计，使用了openai嵌入、GPT3.5 api

## 2.15. [SillyTavern 本地部署的虚拟角色聊天软件](https://github.com/SillyTavern/SillyTavern)

支持多种虚拟角色，也可以自己创造角色，后台可以连多种不同LLM，比如OpenAI、Claude、Llama等，支持TTS（文字转语音）

## 2.16. [OpenCopilot：为各种SaaS产品提供自己的AI助手](https://github.com/openchatai/OpenCopilot)

能集成到产品的API中，根据用户请求执行API调用。

使用LLM来判断用户的请求是否需要调用API端点，然后决定调用哪个端点，并基于给定的API定义传递适当的载荷

## 2.17. [麻将AI竞技场](https://mjai.app/)

## 2.18. [`Council`: 旨在通过团队协作的方式，快速开发和部署定制强大生成式AI应用的开源平台](https://github.com/chain-ml/council)

## 2.19. [`AgentLLM`：利用开源大语言模型 (LLM) 开发、仅在浏览器上运行的自主智能体的概念证明](https://github.com/idosal/AgentLLM)

其主要目标是证明嵌入式LLM有能力以可接受的性能处理自主智能体的复杂目标导向任务

## 2.20. [`LLMStack` 无代码平台，用于构建生成式 AI 应用、聊天机器人、智能体并将它们连接到数据和业务流程](https://github.com/trypromptly/LLMStack)

## 2.21. [`AutoAgents` 多智能体自动生成框架，基于LLM的自动智能体生成的实验性开源应用，由LLM驱动，自主生成多智能体以实现设定的目标](https://github.com/LinkSoul-AI/AutoAgents)

## 2.22. [`Metaphor`：一种基于大语言模型的搜索引擎](https://github.com/emptycrown/llama-hub/blob/main/llama_hub/tools/notebooks/metaphor.ipynb)
...
## 2.23. [`MindOS`: 提供 AI 对话，能力包括: `API`, `Workflow`, `Knowledge`, `Memory`](https://www.mindos.com)
...
这些东西组合起来可玩性就比较强，例如可以让它从 Github Trending 上抓取今日最热的 Top5 内容，将内容分析出来之后，为每条内容配上从 Google 抓取的题图，然后使用 Markdown 格式生成一篇日报。

这个操作对程序员来说或许不复杂，但工具可以做到降低门槛，让普通人也玩得转，并且提升了工具的制作效率，这个价值就比较大了
...
## 3.10. [AutoTrain: 微调HF LLM的UI工具](https://github.com/huggingface/autotrain-advanced)

任何人都可以通过上传 CSV 并选择参数并单击按钮来微调（几乎） Hugging Face Hub 上提供的任何 LLM！

## 3.11. [CLIP 知识蒸馏：执行 OpenCLIP 模型的知识蒸馏，用零标记数据创建自定义图像分类模型](https://github.com/NVIDIA-AI-IOT/clip-distillation)

## 3.12. [Giraffe：世界上第一个商业可用的32K长上下文开源LLM（基于Llama-2）](https://github.com/abacusai/long-context)

## 3.13. [Meta 发布 `Code Llama`](https://github.com/facebookresearch/codellama)
...
## 4.11. [基于大语言模型的 AI Agents](https://www.breezedeus.com/article/ai-agent-part1)

## 4.12. [OpenAI GPT-3.5 微调实战](https://github.com/LearnPrompt/LLMs-cookbook/tree/main/gpt3.5)
...
# 4.16. GPT4 Promt（提示） 范例：帮助你 在不熟悉的领域 做出 工程决策：
...
## 5.14. 资讯：[ElevenLabs 多语言语音生成模型 Eleven Multilingual v2](https://elevenlabs.io/blog/multilingualv2/)
