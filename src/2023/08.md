...
- [2. 项目 / 框架](#2-项目--框架)
  ...
  - [2.17. `Council`: 旨在通过团队协作的方式，快速开发和部署定制强大生成式AI应用的开源平台](#217-council-旨在通过团队协作的方式快速开发和部署定制强大生成式ai应用的开源平台)
  - [2.18. `AgentLLM`：利用开源大语言模型 (LLM) 开发、仅在浏览器上运行的自主智能体的概念证明](#218-agentllm利用开源大语言模型-llm-开发仅在浏览器上运行的自主智能体的概念证明)
  - [2.19. `LLMStack` 无代码平台，用于构建生成式 AI 应用、聊天机器人、智能体并将它们连接到数据和业务流程](#219-llmstack-无代码平台用于构建生成式-ai-应用聊天机器人智能体并将它们连接到数据和业务流程)
  - [2.20. `AutoAgents` 多智能体自动生成框架，基于LLM的自动智能体生成的实验性开源应用，由LLM驱动，自主生成多智能体以实现设定的目标](#220-autoagents-多智能体自动生成框架基于llm的自动智能体生成的实验性开源应用由llm驱动自主生成多智能体以实现设定的目标)
  - [2.21. `Metaphor`：一种基于大语言模型的搜索引擎](#221-metaphor一种基于大语言模型的搜索引擎)
- [3. 模型](#3-模型)
...
## 2.17. [`Council`: 旨在通过团队协作的方式，快速开发和部署定制强大生成式AI应用的开源平台](https://github.com/chain-ml/council)

## 2.18. [`AgentLLM`：利用开源大语言模型 (LLM) 开发、仅在浏览器上运行的自主智能体的概念证明](https://github.com/idosal/AgentLLM)

其主要目标是证明嵌入式LLM有能力以可接受的性能处理自主智能体的复杂目标导向任务

## 2.19. [`LLMStack` 无代码平台，用于构建生成式 AI 应用、聊天机器人、智能体并将它们连接到数据和业务流程](https://github.com/trypromptly/LLMStack)

## 2.20. [`AutoAgents` 多智能体自动生成框架，基于LLM的自动智能体生成的实验性开源应用，由LLM驱动，自主生成多智能体以实现设定的目标](https://github.com/LinkSoul-AI/AutoAgents)

## 2.21. [`Metaphor`：一种基于大语言模型的搜索引擎](https://github.com/emptycrown/llama-hub/blob/main/llama_hub/tools/notebooks/metaphor.ipynb)
