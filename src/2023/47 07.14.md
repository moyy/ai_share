...
# 13. [GPT-4 技术细节](http://t.cn/A60ZGFtY)
...
+ [Real-CUGAN: 与`Waifu2x`兼容的通用动漫图像超分辨率模型](https://github.com/bilibili/ailab/tree/main/Real-CUGAN#real-cascade-u-nets-for-anime-image-super-resolution)
+ [Squirrel-RIFE: 中文补帧软件](https://github.com/Justin62628/Squirrel-RIFE)
+ [Waifu2x-Extension-GUI: GUI版本](https://github.com/AaronFeng753/Waifu2x-Extension-GUI/blob/master/README_CN.md)
+ [Paper2GUI](https://github.com/Baiyuetribe/paper2gui): 即开即用，已支持 40+AI 模型: AI 绘画、语音合成、视频补帧、视频超分、目标检测、图片风格化、OCR 识别
