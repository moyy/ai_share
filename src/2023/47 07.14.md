- [22. Stable Doodle 生成动态图像](#22-stable-doodle-生成动态图像)
...
- [14. AnimateDiff: 文本到图像模型添加动画效果](#14-animatediff-文本到图像模型添加动画效果)
...
# 22. [Stable Doodle 生成动态图像](https://stability.ai/blog/clipdrop-launches-stable-doodle)

Stability AI推出了一款名为Stable Doodle的工具，这是一款将简单的绘图转换为动态图像的工具，

有了Stable Doodle，任何具有基本绘画技能和在线访问能力的人都可以在几秒钟内生成高质量的原创图像。
...
# 14. [AnimateDiff: 文本到图像模型添加动画效果](http://t.cn/A60Z1AAG)
A
