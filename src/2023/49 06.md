- [2023.06](#202306)
- [01. OpenAI 进展](#01-openai-进展)
- [02. Azure OpenAI API 的性能](#02-azure-openai-api-的性能)
- [03. 自然语言 搜索 HuggingFace模型](#03-自然语言-搜索-huggingface模型)
- [04. 思维树 ToT](#04-思维树-tot)
- [05. LTM-1 5000K Token](#05-ltm-1-5000k-token)
- [06. Diffusers 0.17](#06-diffusers-017)
- [07. Huggingface Transformer 2.0](#07-huggingface-transformer-20)
...
- [17. `Demo` 普林斯顿：`Infinigen` 程序生成虚拟场景](#17-demo-普林斯顿infinigen-程序生成虚拟场景)
- [18. WizardCoder: 编程任务仅次于GPT](#18-wizardcoder-编程任务仅次于gpt)
- [19. Replicate 提供 Stable Diffuse API](#19-replicate-提供-stable-diffuse-api)
...
# 02. [Azure OpenAI API](https://51.ruyo.net/18402.html) 的性能
...
# 03. 自然语言 搜索 HuggingFace模型

通过自然语言，快速检索 HuggingFace 各种模型。

通过这种方式，我们可以挖掘到各类「图像生成」、「文档智能对话」、「AI 视频合成」等实用的 AI 模型。

# 04. [思维树 ToT](https://zhuanlan.zhihu.com/p/633974673)

+ CoT 思维链
+ ToT 思维树

# 05. [LTM-1 5000K Token](https://weibo.com/1727858283/N4hBhEhgf)
...
# 06. [Diffusers 0.17](github.com/huggingface/diffusers)
...
# 07. [Huggingface Transformer 2.0](github.com/xenova/transformers.js/)
...
# 17. `Demo` [普林斯顿：`Infinigen` 程序生成虚拟场景](https://github.com/princeton-vl/infinigen)
...
# 18. [WizardCoder: 编程任务仅次于GPT](https://www.jiqizhixin.com/articles/2023-06-20-5)

![](../../images/20230620193724.png)

# 19. [Replicate 提供 Stable Diffuse API](https://replicate.com/)
